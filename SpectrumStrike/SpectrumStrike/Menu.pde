class MainMenu{
 ...
 void displayHowTo(){
   ...
   stroke(255, 20, 147);
   strokeWeight(3);
   triangle(2*SCREENX/8, 3*SCREENY/16 - 0.7*INVADER1_HEIGHT,
            2*SCREENX/8 - 0.7*INVADER1_WIDTH, 3*SCREENY/16 + 0.6*INVADER1_HEIGHT,
            2*SCREENX/8 + 0.7*INVADER1_WIDTH, 3*SCREENY/16 + 0.6*INVADER1_HEIGHT);
   ...
   rect(2*SCREENX/8+.4*INVADER1_WIDTH,3*SCREENY/16+.3*INVADER1_HEIGHT,.1*INVADER1_WIDTH,.2*INVADER1_HEIGHT);
    ...
    stroke(0, 191, 255);
    strokeWeight(3);
    ellipse(2*SCREENX/8, 4*SCREENY/16+2, 0.7*INVADER2_WIDTH, 0.7*INVADER2_HEIGHT);
    ...
    strokeWeight(3);
    rectMode(CENTER);
    rect(2*SCREENX/8, 5*SCREENY/16, 1.4*INVADER3_WIDTH, 1.4*INVADER3_HEIGHT);
    rectMode(CORNER);
    ...
    rect(2*SCREENX/8-POWER_UP_WIDTH/2,12*SCREENY/16-POWER_UP_HEIGHT/2,POWER_UP_WIDTH,POWER_UP_HEIGHT);
    ...
    text("A",2*SCREENX/8,12*SCREENY/16+10);
    text("S",2*SCREENX/8,13*SCREENY/16+10);
    text("D",2*SCREENX/8,14*SCREENY/16+10);
    ...
    text("Target Type 1 (Pink)",4*SCREENX/8,12*SCREENY/16+10);
    text("Target Type 2 (Cyan)",4*SCREENX/8,13*SCREENY/16+10);
    text("Target Type 3 (Green)",4*SCREENX/8,14*SCREENY/16+10);
